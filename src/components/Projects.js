...
const Projects = (props) => {
  if(props.data){
    ...
    var icons = [{icon:<GiBrain className="commonIcons" />},{icon:<DiGoogleAnalytics className="commonIcons" />},{icon:<FcParallelTasks className="commonIcons" />}]
    var state = props.data.project.map(function(inf, index){
       return <div key={inf.id} className="col-4 bgMain">
        ...
        <div className="projects__header">
          ...
          <div className="row bgMain">
            ...
            <div className="header__buttons">
              <a href="https://www.linkedin.com/in/niharika-dalsania-0791021a9" target="_blank" rel="noopener noreferrer" className="btn btn-outline">
                More Projects
              </a>
            </div>
          </div>
