                ...
                <div className="type">
                  <Typewriter
                    ...
                    onInit={(typewriter) => {
                      typewriter
                        .typeString(
                          'I\'m <strong><span style="color: #ff4a57;">Machine Learning Enthusiastic</span>'
                        )
                        .pauseFor(2000)
                        .deleteChars(29)
                        .typeString(
                          '<strong><span style="color: #ff4a57;">Product Engineer Intern at Spriklr</span>'
                        )
                        .pauseFor(2000)
                        .deleteChars(34)
                        .typeString(
                        ...
                        .deleteChars(37)
                        .typeString(
                          '<strong><span style="color: #ff4a57;">Skilled Programmer</span>'
                        )
                        .pauseFor(2000)
                        .start();
                    }}
